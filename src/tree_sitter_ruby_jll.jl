...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import tree_sitter_ruby_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("64e8d737-0d98-5a82-81e1-7af1483a77cc"))
platforms = [Pkg.Artifacts.unpack_platform(e, "tree_sitter_ruby", artifacts_toml) for e in artifacts["tree_sitter_ruby"]]
...
if best_platform === nothing
    @debug("Unable to load tree_sitter_ruby; unsupported platform $(triplet(platform_key_abi()))")
else
...
end  # module tree_sitter_ruby_jll
